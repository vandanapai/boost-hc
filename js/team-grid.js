...
var Grid = (function() {
	...
	Preview.prototype = {
		...
		update : function( $item ) {
			...
			// if already expanded remove class "about-expanded" from current item and add it to new item
			if( current !== -1 ) {
				var $currentItem = $items.eq( current );
				$currentItem.removeClass( 'about-expanded' );
				this.$item.addClass( 'about-expanded' );
		...
		close : function() {
			...
			var self = this,
				onEndFn = function() {
					...
					self.$item.removeClass( 'about-expanded' );
		...
		setHeights : function() {
			...
			var self = this,
				onEndFn = function() {
					...
					self.$item.addClass( 'about-expanded' );
				};
